...
const messagesDictionary = { 
  ...
  noMessage:[ 
    ...
    "This button is just 4 fun. Don't try!",
    ...
    "Heart is on the left, click the left button :)",
    ...
    "Catch me if you can...",
    "Wohahah destiny doesn't allow that to be clicked.",
    "Be careful, it's a tick bomb.",
    "Don't worry, you can't run away from this?",
  ...
  yesMessage:[ 
    ...
    "I know it!",
    "Awwww...~.~",
    "Sun sets at the wrong direction today?",
